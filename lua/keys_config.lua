...
vim.api.nvim_set_keymap('n', '<Left>', '<Esc>:vertical resize -2<CR>', opts)
vim.api.nvim_set_keymap('n', '<Up>', '<Esc>:resize +2<CR>', opts)
vim.api.nvim_set_keymap('n', '<Down>', '<Esc>:resize -2<CR>', opts)
vim.api.nvim_set_keymap('n', '<Right>', '<Esc>:vertical resize +2<CR>', opts)
